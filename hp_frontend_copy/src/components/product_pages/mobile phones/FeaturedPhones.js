...
const FeaturedPhones = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                setLoading(true);
                const response = await fetch(`${API_BASE_URL}/api/featured-phones`);
    ...
    if (loading) return <LuxuryLoader message="Loading Featured Phones" />;
            ...
            <Container sx={styles.container}>
                <Box sx={styles.header}>
                    <Typography sx={styles.resultsText}>
                        Featured Phones <span>({filteredProducts.length} products found)</span>
                    </Typography>
                </Box>
