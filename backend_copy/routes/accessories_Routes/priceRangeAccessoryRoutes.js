...
// GET accessories by price range using stored procedure
router.get("/:priceRange", async (req, res) => {
    try {
        ...
        const result = await pool.request()
            ...
            .execute("proc_getdefaultproducts_bypriceAcc");
        ...
        console.error('Error in price range accessories route:', err);
